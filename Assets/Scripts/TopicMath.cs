...
public class TopicMath : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        string chosenTopic = PlayerPrefs.GetString("SelectedTopic", "Arithmetic");
    ...
    public void NextRight()
    {
        ...
        if (name == "Arithmetic")//dadami yung condition depende sa bilang ng mga topic
        {
            //palitan nalang yung pagkukunan ng data ng score, depende kung san mo isa-save yung sore
            //TopicGrade.text = topicGrade;
            activeTopic.sprite = Top2;
            subText.text = "Measurements";
            topicName.text = "Measurements";
            PlayerPrefs.SetString("SelectedTopic", "Measurements");
        ...
        if (name == "Measurements")
        {
            ...
            //TopicGrade.text = topicGrade;
            activeTopic.sprite = Top3;
            subText.text = "Geometry";
            topicName.text = "Geometry";
            PlayerPrefs.SetString("SelectedTopic", "Geometry");
        ...
        if (name == "Geometry")
        {
            ...
            //TopicGrade.text = topicGrade;
            activeTopic.sprite = Top1;
            subText.text = "Arithmetic";
            topicName.text = "Arithmetic";
            PlayerPrefs.SetString("SelectedTopic", "Arithmetic");
